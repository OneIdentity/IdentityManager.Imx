...
- Bug 447702: Web Portal: Filtering: Canceling defining a filter does not reset filters (reappearing)
- Bug 447018: In DataExplorer System Entitlements, the defaultness of a table column can be changed by loading a view
- Bug 444890: Portal: Selected Products on New Request Page outlast session and user
- Bug 434023: Special filtering, like User Accounts Target system based narrowing, when loaded by a saved view, causes UI issues
- Bug 446516: User dependent column cache in filter wizard does not update when user changed
- Bug 446585: Web Portal: My responsibilities: System entitlements: Child system entitlements: Odd/empty target system information
- Bug 445251: Clicking while load spinner shows prevents (result) sidesheet to (remain) open
- Bug 445482: BUG Risk index functions visible when RISKINDEX is off
- Bug 444322: Adressbook - added column disappears in grouping
...
- Bug 444268: Portal: Selected Products on Products by Reference User tab gone away
- Bug 418493: Angular displays incomplete list of current approvers (sibling steps of the current decision level are ignored)
- Bug 425801: The shopping cart should not suggest that a partial check or partial submit is possible
- Product Backlog Item 441990: Enhance hotfix delivery to support Angular packages with static dependencies
- Bug 445856: Github: CDR required logic backwards
...
- Bug 445927: AdminPortal: On smaller screens the menu is not visible
- Bug 445169: Operations Support Portal: Operation history: Type of operation not shown when language is German
- Bug 442577: Column picker for view configuration showing wrong columns
- Bug 420941: API Server: Web application overview: Clicking the title opens the Administration Portal
- Bug 442577: Column picker for view configuration showing wrong columns
- Bug 446290: Web Portal: System entitlement ownership: Drop-down list does not load all entries
- Bug 447700: Web Portal: New request: Tabs are not using context-sensitive help
- Bug 447417: In Filter Data sidesheet, custom filters for properties, which have datatype double, allow non-numerical values
- Bug 446996: Angular Web: only 20 Subcategories are visible on New Request - page
...
- Product Backlog Item 440883: Web Portal: Pending attestations: Hyperviews: Add object types to list
- Product Backlog Item 438294: 9.2: Web portal should allow navigation in Hyperviews
- Bug 443469: In Filter Data sidesheet, existing custom filters can be mutated in sneaky ways, even if the user cancels the sidesheet
- Bug 432848: In New Request Page, within View Selected Products, sorting seems to be not implemented yet sort arrows show up visually
- Bug 443469: In Filter Data sidesheet, existing custom filters can be mutated in sneaky ways, even if the user cancels the sidesheet
- Bug 441058: Webportal page number doesn't reset when changing the filter
