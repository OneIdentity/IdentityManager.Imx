...
430844: Inconsistency in Attestation History when approver is defined in multiple sublevels fixed.
...
472739: Fixes issues with the Data Explorer menu structure if the user lacks rights.
459188: Fixes an issue with ae missing attestor filter on the Attestation history page.
...
470472: Adds no-data indication to the product bundle page.
