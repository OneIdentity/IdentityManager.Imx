...
import { AadUserSubscriptionsComponent } from './aad-user-subscriptions.component';

describe('AadUserSubscriptionComponent', () => {
  let component: AadUserSubscriptionsComponent;
  let fixture: ComponentFixture<AadUserSubscriptionsComponent>;

  AadTestBed.configureTestingModule({
    declarations: [ AadUserSubscriptionsComponent ],
    imports: [
      MatDialogModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AadUserSubscriptionsComponent);
