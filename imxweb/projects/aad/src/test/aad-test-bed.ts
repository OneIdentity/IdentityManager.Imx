...
import { AadCommonTestData } from './aad-common-test-mocks';

export class AadTestBed {
    ...
    const baseProviders = [
      {
        ...
        useValue: AadCommonTestData.mockAppConfigService
      },
      {
        provide: AuthenticationService,
        useValue: AadCommonTestData.mockAuthenticationServiceStub
      }
    ];
