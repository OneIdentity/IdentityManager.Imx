...
import { NotificationsModule } from '../information/notifications/notifications.module';
...
@NgModule({
  ...
  imports: [CommonModule, ObjectSearchModule, NotificationsModule, ServiceIssuesModule, ServiceReportModule, TranslateModule],
})
