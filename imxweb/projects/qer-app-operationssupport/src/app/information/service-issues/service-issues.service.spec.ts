...
import { ServiceIssueItem } from './service-issue-item';
  ...
  TestBed.configureTestingModule({
    providers: [
      ...
      },
      {
        ...
        useValue: {
          ItemsProvider: jasmine
            .createSpy('ItemsProvider')
            .and.returnValue(Promise.resolve({} as Promise<TypedEntityCollectionData<OpsupportSystemoverview>>)),
        },
      },
      {
        provide: SystemTreeDatabase,
        useValue: {
          initialize: jasmine.createSpy('initialize').and.callFake(() => Promise.resolve([])),
        },
      },
      {
