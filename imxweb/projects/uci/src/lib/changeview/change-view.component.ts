...
import { ManualChangeOperationData, OpsupportUciChangedetail, OpsupportUciChanges } from '@imx-modules/imx-api-uci';
import {
...
import { calculateSidesheetWidth, DataSourceToolbarFilter, DataSourceToolbarSettings, DataSourceWrapper, MetadataService } from 'qbm';
...
export class ChangeViewComponent implements OnInit {
  ...
  public async viewDetails(change: TypedEntity): Promise<void> {
    this.changeviewService.handleOpenLoader();
