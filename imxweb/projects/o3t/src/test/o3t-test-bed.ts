...
import { O3tCommonTestData } from './o3t-common-test-mocks';

export class O3tTestBed {
    ...
    const baseProviders = [
      {
        ...
        useValue: O3tCommonTestData.mockAppConfigService
      },
      {
        provide: AuthenticationService,
        useValue: O3tCommonTestData.mockAuthenticationServiceStub
      }
    ];
