...
describe('TeamsComponent', () => {
  ...
  describe('onTeamChanged() tests', () => {
    it('should call `openDetailsSidesheet` with the selected team', () => {
      const openDetailsSidesheetSpy = spyOn<any>(component, 'openDetailsSidesheet');
      component.onTeamChanged(O3tCommonTestData.mockTeam);
      expect(openDetailsSidesheetSpy).toHaveBeenCalledWith('Display value', O3tCommonTestData.mockTeam);
    });
  });
});
