...
describe('DataExplorerNoDataComponent', () => {
  let component: DataExplorerNoDataComponent;
  let fixture: ComponentFixture<DataExplorerNoDataComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DataExplorerNoDataComponent);
