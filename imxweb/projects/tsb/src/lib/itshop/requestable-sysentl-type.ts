...
export class RequestableSystemEntitlementType implements IRequestableEntitlementType {

  constructor(private readonly tableName: string,
    private readonly tsbApi: TsbApiService,
  ...
  public createAssignmentEntity(shelfId: string): TypedEntity {
    const entityColl = this.dynamicMethodService.createEntity(this.tsbApi.apiClient, {
