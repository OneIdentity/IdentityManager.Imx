...
import { AobKpiGuardService } from './aob-kpi-guard.service';
...
describe('AobKpiGuardService', () => {
  let service: AobKpiGuardService;
  ...
  beforeEach(() => {
    service = TestBed.inject(AobKpiGuardService);
  });
  ...
  it("canActivate() should return false if user doesn't have AOB_4_AOB_ADMIN group", fakeAsync(() => {
