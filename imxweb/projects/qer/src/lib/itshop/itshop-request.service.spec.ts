...
import { ItshopRequestService } from './itshop-request.service';
import { ItshopService } from './itshop.service';

describe('ItshopRequestService', () => {
  let service: ItshopRequestService;
  ...
  configureTestSuite(() => {
    ...
    service = TestBed.inject(ItshopRequestService);
  });
