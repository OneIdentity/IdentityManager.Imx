...
describe('BusinessOwnerOverviewTileComponent', () => {
  let component: BusinessOwnerOverviewTileComponent;
  let fixture: ComponentFixture<BusinessOwnerOverviewTileComponent>;

  configureTestSuite(() => {
    TestBed.configureTestingModule({
      declarations: [
        BusinessOwnerOverviewTileComponent,
        MockTileComponent
      ]
    });
  });
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BusinessOwnerOverviewTileComponent);
