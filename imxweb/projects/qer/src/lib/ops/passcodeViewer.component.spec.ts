...
describe('PasscodeViewerComponent', () => {
  let component: PasscodeViewerComponent;
  let fixture: ComponentFixture<PasscodeViewerComponent>;
  ...
  configureTestSuite(() => {
    TestBed.configureTestingModule({
      declarations: [PasscodeViewerComponent, MockLdsReplacePipe],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PasscodeViewerComponent);
