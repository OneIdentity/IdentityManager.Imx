...
export { DecisionReasonComponent } from './lib/itshop/decision-reason/decision-reason.component';
export { RequestInfoComponent } from './lib/itshop/request-info/request-info.component';
export { JustificationService } from './lib/itshop/justification.service';
export { JustificationType } from './lib/itshop/justification-type.enum';
...
export { AttestationReferrer } from './lib/referrers/attestation-referrer.interface';
export { AccountReferrer } from './lib/referrers/account-referrer.interface';
...
export { ObjectAttestationModule } from './lib/object-attestation/object-attestation.module';
export { ObjectAttestationComponent } from './lib/object-attestation/object-attestation.component';
