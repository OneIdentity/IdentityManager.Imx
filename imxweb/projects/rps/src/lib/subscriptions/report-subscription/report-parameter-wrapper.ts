...
import { EntityWriteDataColumn, IFkCandidateProvider, IEntityColumn, ParameterData, WriteExtTypedEntity, } from 'imx-qbm-dbts';
...
export class ReportParameterWrapper {
  ...
  constructor(
    ...
    private typedEntity: WriteExtTypedEntity<ParameterData[][]>
  ) {
