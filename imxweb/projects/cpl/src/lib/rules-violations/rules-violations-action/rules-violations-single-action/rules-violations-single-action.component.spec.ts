...
import { RulesViolationsSingleActionComponent } from './rules-violations-single-action.component';

describe('RulesViolationsSingleActionComponent', () => {
  let component: RulesViolationsSingleActionComponent;
  let fixture: ComponentFixture<RulesViolationsSingleActionComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RulesViolationsSingleActionComponent);
