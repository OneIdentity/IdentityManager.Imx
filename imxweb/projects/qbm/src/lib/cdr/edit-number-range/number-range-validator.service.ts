...
import { NumberValidatorService, NumericInput } from '../edit-number/number-validator.service';
...
export class NumberRangeValidatorService {
   ...
   */
  public validateValue(value: NumericInput, constraint: ValueConstraint | undefined): NumberRangeError | null {
   ...
   * @returns A NumberRangeError if validation fails, otherwise null.
   */
  public validateRangeOrder(from: NumericInput, to: NumericInput): NumberRangeError | null {
   ...
   * @returns A NumberRangeError if validation fails, otherwise null.
   */
  public validateRange(from: NumericInput, to: NumericInput, constraint: ValueConstraint | undefined): NumberRangeError | null {
