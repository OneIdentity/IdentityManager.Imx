...
import { DataTableDisplayCellComponent } from './data-table-display-cell.component';

describe('DataTableDisplayCellComponent', () => {
  let component: DataTableDisplayCellComponent;
  let fixture: ComponentFixture<DataTableDisplayCellComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DataTableDisplayCellComponent);
  ...
  for (const testcase of [
    ...
    it('should create', () => {
      ...
      const dataTableCellSpan = nativeElement.getElementsByTagName('div')[0];
