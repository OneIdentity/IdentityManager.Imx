...
import { ArcGovernanceCommonTestData } from './common-test-mocks';

export class ArcGovernanceTestBed {
    ...
    const baseProviders = [
      {
        ...
        useValue: ArcGovernanceCommonTestData.mockAppConfigService
      },
      {
        provide: AuthenticationService,
        useValue: ArcGovernanceCommonTestData.mockAuthenticationServiceStub
      }
    ];
